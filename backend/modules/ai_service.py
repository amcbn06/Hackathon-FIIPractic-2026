...
# 3. RUTA 1: GENERARE TRASEU INTELIGENT (Din DB-ul vostru)
...
def generate_smart_route(data: AIItineraryRequest, db: Session = Depends(get_db)):
    ...
    ai_insight = f"Am analizat cele {len(stops)} locații din {city}. Traseul optimizat pentru mood-ul tău ({moods_text}) începe cu o echipă entuziastă și se termină în cel mai popular punct de interes."
...
# 4. RUTA 2: VALIDARE & GENERARE SPOTS (Magic Add)
